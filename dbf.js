(function(window,undefined){
    ...
    DBF.prototype = {
        ...
        readRecords: function(){
            var s = this.stream;
            var numRecords = this.header.numRecords;
            var recordsOffset = this.header.firstRecordPosition;
            var recordSize = this.header.recordLength;
            ...
            for (var index = 0; index < numRecords; index++) {
                ...
                // Data records begin with a delete flag byte. If this byte is an ASCII space (0x20),
                // the record is not deleted. If the first byte is an asterisk (0x2A),
